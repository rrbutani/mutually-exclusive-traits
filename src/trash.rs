...
#[marker] auto trait IsA { }
impl<A: Clone> !IsA for A { }
impl<A: Default> !IsA for A { }

#[marker] trait IsLiteral<B: Bool> { }
impl<L: Literal> IsLiteral<Yes> for L { }
impl<L: Literal + UnaryOp> IsLiteral<No> for L { }
impl<L: Literal + BinaryOp> IsLiteral<No> for L { }
